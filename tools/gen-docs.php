...
/**
 * This file is part of milpa/auth-webauthn — WebAuthn/passkeys for the Milpa PHP
 * framework.
 *
...
/**
 * Generates the static API reference site for milpa/auth-webauthn.
 *
 ...
 * milpa/core is not a runtime dependency of milpa/auth-webauthn): reflects over
...
$config = new Milpa\Docs\SiteConfig(
    brand: 'Milpa Auth-WebAuthn',
    nsPrefix: 'Milpa\\Auth\\WebAuthn\\',
    installCommand: 'composer require milpa/auth-webauthn',
    repoUrl: 'https://github.com/getmilpa/auth-webauthn',
    pagesUrl: 'https://getmilpa.github.io/auth-webauthn/',
    heroParagraph: '<strong>WebAuthn / passkeys</strong> for Milpa: the <strong>WebAuthnVerifier</strong>, '
        . '<strong>ChallengeStore</strong> and <strong>WebAuthnCredentialStore</strong> contracts, the ceremony '
        . 'value objects, in-memory reference stores, and a <strong>lbuchs/webauthn</strong> adapter that does the '
        . 'cryptography. A verified assertion <strong>mints a session</strong> — never a per-request transport — so '
        . 'the host, not the verifier, turns proof into an AuthContext. One tier above milpa/auth; zero framework, zero ORM.',
    utmContent: 'auth-webauthn',
);
